...
* *Simpson's paradox* is when the sign of the correlation flips when computed on the entire population (total admissions) versus when computed on specific strata (admissions by major). For example, we have 3 variables, x, y, and z. The correlation of x and y is -0.68:
<img src = "https://rafalab.github.io/dsbook/book_files/figure-html/simpsons-paradox-1.png" width = 200 height = 200>
    
* But, once its stratified by z (the confounder), the correlation changes to somewhere around 0.7:
<img src = "https://rafalab.github.io/dsbook/book_files/figure-html/simpsons-paradox-explained-1.png" width = 200 height = 200>

* So, z is negativley correlated with x.
